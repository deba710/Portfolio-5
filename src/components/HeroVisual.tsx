    ...
    <div className="relative w-full max-w-[440px] mx-auto select-none flex items-center justify-center">
      ...
      >
        ...
        <div className="w-24 h-24 border border-white/20 rounded-full flex items-center justify-center mb-6 relative">
          <span className="text-5xl font-black text-white/10 absolute -top-4 -left-4">
            D
          </span>
          <div className="w-20 h-20 bg-gradient-to-tr from-cyan-900 to-purple-900 rounded-full flex items-center justify-center border border-cyan-400/30 shadow-[0_0_20px_rgba(34,211,238,0.2)]">
