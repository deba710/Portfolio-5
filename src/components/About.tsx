...
export const About: React.FC = () => {
  ...
  return (
    <section id="about" className="py-24 sm:py-32 relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 border-t border-white/[0.06]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 xl:gap-16 items-start">
        ...
        {/* Left Side: Long-form Bio & Perspective (7 cols) */}
        <div className="lg:col-span-7 space-y-6">
          <p className="text-lg sm:text-xl lg:text-xl text-neutral-200 leading-relaxed font-normal">
            {personal.aboutBio}
          </p>

          <div className="p-6 sm:p-7 rounded-2xl bg-white/[0.02] border border-white/[0.08] space-y-3.5">
            <div className="text-xs font-mono tracking-wider text-cyan-300 uppercase flex items-center gap-2 font-semibold">
        ...
        {/* Right Side: Technical Information Panel (5 cols) */}
        <div className="lg:col-span-5">
          <div className="rounded-2xl bg-[#090d15] border border-white/[0.1] p-6 sm:p-7 shadow-[0_10px_30px_rgba(0,0,0,0.5)] space-y-6 relative overflow-hidden">
            ...
            {/* Top Accent line */}
            <div className="absolute top-0 left-0 right-0 h-[2px] bg-gradient-to-r from-cyan-400 via-sky-400 to-indigo-500" />
